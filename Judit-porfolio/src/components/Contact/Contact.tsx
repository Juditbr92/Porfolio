        ...
        <div className="h-[80vh] w-[90vw] flex flex-col mx-auto">
            ...
            <div className="flex h-full">
                <div className="flex flex-col w-1/2 my-auto gap-y-10">
                    ...
                    <div className="border-2 border-gray-300 flex h-16 items-center justify-items-center mx-auto gap-8">
                ...
                <div className="flex flex-col w-1/2 border-2 border-amber-500">
